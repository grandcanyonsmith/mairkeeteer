...
class FinalEmailCreator:
    ...
    def append_to_file(self, final_email, temp_file):
        temp_file = "/Users/canyons/Documents/GitHub/mairkeeteer/files/data/temp/temp.jsonl"
...
if __name__ == "__main__":
    ...
    final_email = final_email_creator.append_to_file(final_email, temp_file)
