...
def openai_complete(prompt):
    ...
    all_text = pathlib.Path(
        "/Users/canyons/Documents/GitHub/mairkeeteer/files/data/examples/html_css_example.jsonl"
    ).read_text()
...
#     return last_line
# print(get_last_line_of_file("/Users/canyons/Documents/GitHub/mairkeeteer/files/data/examples/html_css_example.jsonl"))