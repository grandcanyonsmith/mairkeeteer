    ...
    def parse_headers(
        ...
        while line:
            ...
            if len(bname) > self.max_field_size:
                raise LineTooLong(f'request header name {bname.decode("utf8", "xmlcharrefreplace")}', str(self.max_field_size), str(len(bname)))
            ...
            if continuation := line and line[0] in (32, 9):
                ...
                while continuation:
                    ...
                    if header_length > self.max_field_size:
                        raise LineTooLong(f'request header field {bname.decode("utf8", "xmlcharrefreplace")}', str(self.max_field_size), str(header_length))
...
class HttpRequestParser(HttpParser[RawRequestMessage]):
    ...
    def parse_message(self, lines: List[bytes]) -> RawRequestMessage:
        ...
        try:
            ...
            raise BadStatusLine(version) from e
...
class DeflateBuffer:
    ...
    def feed_data(self, chunk: bytes, size: int) -> None:
        ...
        try:
            ...
            raise ContentEncodingError(f"Can not decode content-encoding: {self.encoding}") from e
