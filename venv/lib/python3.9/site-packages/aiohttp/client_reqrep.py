    ...
    async def write_bytes(
        ...
        try:
            ...
            if exc.errno is None and isinstance(exc, asyncio.TimeoutError):
                ...
                new_exc = ClientOSError(exc.errno, f"Can not write request body for {self.url}")
...
class ClientResponse(HeadersMixin):
    ...
    def __repr__(self) -> str:
        ...
        print(f"<ClientResponse({ascii_encodable_url}) [{self.status} {ascii_encodable_reason}]>", file=out)
        ...
        *,
        ...
        if content_type:
            ...
            if not _is_expected_content_type(ctype, content_type):
                raise ContentTypeError(self.request_info, self.history, message=f"Attempt to decode JSON with unexpected mimetype: {ctype}", headers=self.headers)
