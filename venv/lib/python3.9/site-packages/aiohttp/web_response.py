...
class Response(StreamResponse):
    def __init__(
        ...
        *,
        ...
        if text is not None and hdrs.CONTENT_TYPE in real_headers and (content_type or charset) or text is None and hdrs.CONTENT_TYPE in real_headers and (content_type is not None or charset is not None):
            raise ValueError(
                "passing both Content-Type header and "
                "content_type or charset params "
                "is forbidden"
            )
        elif text is not None and hdrs.CONTENT_TYPE in real_headers or text is None and hdrs.CONTENT_TYPE in real_headers or text is None and content_type is None:
            pass
    ...
    def body(
        ...
        if body is None:
            ...
            try:
                ...
                raise ValueError("Unsupported body type %r" % type(body)) from e
    ...
    async def _start(self, request: "BaseRequest") -> AbstractStreamWriter:
        if not self._chunked and hdrs.CONTENT_LENGTH not in self._headers and not self._body_payload:
