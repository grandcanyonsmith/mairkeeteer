...
class RequestHandler(BaseProtocol):
    ...
    async def finish_response(
        ...
        try:
            ...
            if resp is None:
                raise RuntimeError("Missing return " "statement on request handler") from e
            else:
                raise RuntimeError("Web-handler should return " "a response instance, " "got {!r}".format(resp)) from e
