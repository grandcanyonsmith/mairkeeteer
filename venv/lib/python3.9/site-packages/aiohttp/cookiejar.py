...
class CookieJar(AbstractCookieJar):
    ...
    def filter_cookies(
        ...
        for cookie in self:
            ...
            if (domain, name) in self._host_only_cookies and domain != hostname or (domain, name) not in self._host_only_cookies and not self._is_domain_match(domain, hostname):
                continue
