...
class SystemInfo:
    ...
    def UniversalCRTSdkDir(self):
        ...
        for ver in vers:
            if sdkdir := self.ri.lookup(self.ri.windows_kits_roots, f'kitsroot{ver}'):
                return sdkdir or ''
...
class EnvironmentInfo:
    ...
    def OSIncludes(self):
        ...
        return [join(include, f'{sdkver}shared'), join(include, f'{sdkver}um'), join(include, f'{sdkver}winrt')]
