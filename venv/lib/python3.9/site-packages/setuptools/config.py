...
class ConfigHandler:
    ...
    def parse(self):
        ...
        for section_name, section_options in self.sections.items():
            ...
            section_parser_method = getattr(self, f'parse_section{method_postfix}'.replace('.', '__'), None)


            if section_parser_method is None:
                raise DistutilsOptionError(f'Unsupported distribution option section: [{self.section_prefix}.{section_name}]')
