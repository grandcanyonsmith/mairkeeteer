...
class egg_info(InfoCommon, Command):
    ...
    def finalize_options(self):
        ...
        try:
            ...
            raise distutils.errors.DistutilsOptionError(f"Invalid distribution name or version syntax: {self.egg_name}-{self.egg_version}") from e
...
class FileList(_FileList):
    ...
    def process_template_line(self, line):
        ...
        try:
            ...
            raise DistutilsInternalError("this cannot happen: invalid action '{action!s}'".format(action=action),) from e
...
class manifest_maker(sdist):
    ...
    def prune_file_list(self):
        ...
        sep = re.escape(os.sep)
        self.filelist.exclude_pattern(f'(^|{sep}' + r')(RCS|CVS|\.svn)' + sep, is_regex=1)
