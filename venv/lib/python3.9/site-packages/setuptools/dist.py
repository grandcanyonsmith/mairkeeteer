...
class Distribution(_Distribution):
    ...
    def _move_install_requirements_markers(self):
        ...
        self.extras_require = {k: [str(r) for r in map(self._clean_req, v)] for k, v in self._tmp_extras_require.items()}
    ...
    def _exclude_misc(self, name, value):
        ...
        if old is not None and not isinstance(old, sequence):
            raise DistutilsSetupError(f"{name}: this setting cannot be changed via include/exclude")
