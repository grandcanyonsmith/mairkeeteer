...
you can try compiling with MingW32, by passing "-c mingw32" to setup.py.""") from e
...
class MSVCCompiler(CCompiler) :
    ...
    def manifest_setup_ldargs(self, output_filename, build_temp, ld_args):
        ...
        temp_manifest = os.path.join(build_temp, f"{os.path.basename(output_filename)}.manifest")
