...
class bdist_wininst(Command):
    ...
    def get_installer_filename(self, fullname):
        return os.path.join(self.dist_dir, f"{fullname}.{self.plat_name}-py{self.target_version}.exe") if self.target_version else os.path.join(self.dist_dir, f"{fullname}.{self.plat_name}.exe")
