...
"""
    ...
    def parse_command_line(self):
        ...
        if self.help:
            self._show_help(parser, display_options=not self.commands, commands=self.commands)
    ...
    def get_command_class(self, command):
        ...
        for pkgname in self.get_command_packages():
            ...
            try:
                ...
                raise DistutilsModuleError("invalid command '%s' (no class '%s' in module '%s')" % (command, klass_name, module_name)) from e
