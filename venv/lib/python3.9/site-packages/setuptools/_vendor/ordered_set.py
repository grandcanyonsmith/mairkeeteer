...
class OrderedSet(MutableSet, Sequence):
    ...
    def update(self, sequence):
        ...
        try:
            ...
            raise ValueError(f"Argument needs to be an iterable, got {type(sequence)}") from e
    ...
    def __repr__(self):
        return "%s(%r)" % (self.__class__.__name__, list(self)) if self else f"{self.__class__.__name__}()"
