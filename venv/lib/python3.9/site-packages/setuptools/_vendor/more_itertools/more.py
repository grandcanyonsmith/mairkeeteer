...
def last(iterable, default=_marker):
    ...
    try:
        ...
        if default is _marker:
            raise ValueError('last() was called on an empty iterable, and no default was ' 'provided.') from e
...
class numeric_range(abc.Sequence, abc.Hashable):
    ...
    def __eq__(self, other):
        ...
        return empty_self and empty_other if empty_self or empty_other else (self._start == other._start and self._step == other._step and self._get_by_index(-1) == other._get_by_index(-1))
    ...
    def __getitem__(self, key):
        if isinstance(key, int):
            ...
            raise TypeError(f'numeric range indices must be integers or slices, not {type(key).__name__}')
