...
class Console:
    ...
    def status(
        ...
        *,
        ...
        return Status(status, console=self, spinner=spinner, spinner_style=spinner_style, speed=speed, refresh_per_second=refresh_per_second,)
    ...
    def render(
        ...
        try:
            ...
            raise errors.NotRenderableError(f"object {render_iterable!r} is not renderable") from e
    ...
    def print(
        ...
        *objects: Any,
        ...
        with self:
            ...
            if new_line_start and (len("".join(segment.text for segment in new_segments).splitlines()) > 1):
