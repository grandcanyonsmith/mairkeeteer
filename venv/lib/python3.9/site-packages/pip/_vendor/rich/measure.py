...
class Measurement(NamedTuple):
    ...
    def get(
        ...
        return Measurement(0, 0) if render_width.maximum < 1 else render_width.normalize()
...
def measure_renderables(
    ...
    return Measurement(max(measurements, key=itemgetter(0)).minimum, max(measurements, key=itemgetter(1)).maximum,)
