...
class Node:
    ...
    def render(
        ...
        while line_no < len(lines):
            line = lines[line_no]
            if line.expandable and not line.expanded and (expand_all or not line.check_length(max_width)):
...
class _Line:
    ...
    def expand(self, indent_size: int) -> Iterable["_Line"]:
        ...
        for last, child in loop_last(node.children):
            ...
            yield _Line(parent=new_line, node=child, whitespace=child_whitespace, suffix=separator, last=last and not tuple_of_one,)
...
def pretty_repr(
    ...
    *,
    ...
    return node.render(max_width=max_width, indent_size=indent_size, expand_all=expand_all)
