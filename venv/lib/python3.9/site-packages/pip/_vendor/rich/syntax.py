    ...
    def get_style_for_token(self, token_type: TokenType) -> Style:
        ...
        try:
            ...
            try:
                ...
                style = Style(color=f"#{color}" if color else "#000000", bgcolor=f"#{bgcolor}" if bgcolor else self._background_color, bold=pygments_style["bold"], italic=pygments_style["italic"], underline=pygments_style["underline"])
...
class Syntax(JupyterMixin):
    ...
    def get_theme(cls, name: Union[str, SyntaxTheme]) -> SyntaxTheme:
        ...
        if isinstance(name, SyntaxTheme):
            return name
        theme: SyntaxTheme
        return ANSISyntaxTheme(RICH_SYNTAX_THEMES[name]) if name in RICH_SYNTAX_THEMES else PygmentsSyntaxTheme(name)
