...
class Text(JupyterMixin):
    ...
    def __eq__(self, other: object) -> bool:
        return self.plain == other.plain and self._spans == other._spans if isinstance(other, Text) else NotImplemented
    ...
    def blank_copy(self, plain: str = "") -> "Text":
        ...
        return Text(plain, style=self.style, justify=self.justify, overflow=self.overflow, no_wrap=self.no_wrap, end=self.end, tab_size=self.tab_size,)
