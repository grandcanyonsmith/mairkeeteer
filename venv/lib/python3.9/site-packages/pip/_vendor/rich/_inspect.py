...
class Inspect(JupyterMixin):
    ...
    def _get_signature(self, name: str, obj: Any) -> Optional[Text]:
        ...
        return Text.assemble(("def ", "inspect.def"), (qualname, "inspect.callable"), signature_text)
    ...
    def _render(self) -> Iterable[RenderableType]:
        ...
        if self.value and not isclass(obj) and not callable(obj) and not ismodule(obj):
            yield Panel(
