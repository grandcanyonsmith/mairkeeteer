...
class Color(NamedTuple):
    ...
    def parse(cls, color: str) -> "Color":
        ...
        if color_24:
            triplet = ColorTriplet(int(color_24[:2], 16), int(color_24[2:4], 16), int(color_24[4:6], 16))
...
def parse_rgb_hex(hex_color: str) -> ColorTriplet:
    ...
    return ColorTriplet(int(hex_color[:2], 16), int(hex_color[2:4], 16), int(hex_color[4:6], 16))
...
def blend_rgb(
    ...
    r1, g1, b1 = color1
    r2, g2, b2 = color2
    return ColorTriplet(int(r1 + (r2 - r1) * cross_fade), int(g1 + (g2 - g1) * cross_fade), int(b1 + (b2 - b1) * cross_fade),)
