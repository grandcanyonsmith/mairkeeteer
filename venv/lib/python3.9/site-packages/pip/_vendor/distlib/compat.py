...
try:
    ...
    def _dnsname_match(dn, hostname, max_wildcards=1):
        ...
        if wildcards > max_wildcards:
            ...
            # reasonable choice.
            raise CertificateError(f"too many wildcards in certificate DNS name: {repr(dn)}")
    ...
    class ChainMap(MutableMapping):
        ...
        def __delitem__(self, key):
            try:
                ...
                raise KeyError('Key not found in the first mapping: {!r}'.format(key)) from e
        ...
        def popitem(self):
            ...
            try:
                ...
                raise KeyError('No keys found in the first mapping.') from e
...
# Passes Python2.7's test suite and incorporates all the latest updates.
    ...
    class OrderedDict(dict):
        ...
        def __repr__(self, _repr_running=None):
            ...
            try:
                return '%s(%r)' % (self.__class__.__name__, self.items()) if self else f'{self.__class__.__name__}()'
