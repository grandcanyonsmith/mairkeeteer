...
class RequirementsConflicted(ResolverException):
    ...
    def __str__(self):
        return f'Requirements conflict: {", ".join(repr(r) for r in self.criterion.iter_requirement())}'
...
class Resolution(object):
    ...
    def _add_to_criteria(self, criteria, requirement, parent):
        ...
        incompatibilities = list(criterion.incompatibilities) if criterion else []
    ...
    def resolve(self, requirements, max_rounds):
        ...
        for round_index in range(max_rounds):
            ...
            if failure_causes := self._attempt_to_pin_criterion(name):
