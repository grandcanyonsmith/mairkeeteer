    ...
    class _ProtocolMeta(abc.ABCMeta):
        ...
        def __instancecheck__(cls, instance):
            ...
            if ((not getattr(cls, '_is_protocol', False) or
                ...
                return True
            if cls._is_protocol and all(hasattr(instance, attr) and (not callable(getattr(cls, attr, None)) or getattr(instance, attr) is not None) for attr in _get_protocol_attrs(cls)):
                return True
    ...
    class _ProtocolMeta(GenericMeta):
        ...
        def __new__(cls, name, bases, namespace,
            ...
            self = super(GenericMeta, cls).__new__(cls, name, bases, namespace,
                                                   _root=True)
            super(GenericMeta, self).__setattr__('_gorg', _gorg(origin) if origin else self)
        ...
        def __instancecheck__(self, instance):
            ...
            if ((not getattr(self, '_is_protocol', False) or
                ...
                return True
            if self._is_protocol and all(hasattr(instance, attr) and (not callable(getattr(self, attr, None)) or getattr(instance, attr) is not None) for attr in _get_protocol_attrs(self)):
                return True
    ...
    def _typeddict_new(*args, total=True, **kwargs):
        ...
        if args:
            try:
                ...
                raise TypeError('TypedDict.__new__() takes from 2 to 3 ' f'positional arguments but {len(args) + 2} ' 'were given') from e
...
# 3.6
    ...
    class AnnotatedMeta(typing.GenericMeta):
        ...
        def _tree_repr(self, tree):
            ...
            tp_repr = origin[0]._tree_repr(origin) if isinstance(origin, tuple) else typing._type_repr(origin)
