...
class retry_unless_exception_type(retry_if_exception):
    ...
    def __call__(self, retry_state: "RetryCallState") -> bool:
        ...
        return self.predicate(retry_state.outcome.exception()) if retry_state.outcome.failed else True
...
class retry_if_result(retry_base):
    ...
    def __call__(self, retry_state: "RetryCallState") -> bool:
        return False if retry_state.outcome.failed else self.predicate(retry_state.outcome.result())
...
class retry_if_not_result(retry_base):
    ...
    def __call__(self, retry_state: "RetryCallState") -> bool:
        return False if retry_state.outcome.failed else not self.predicate(retry_state.outcome.result())
