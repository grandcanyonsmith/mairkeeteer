...
class RegexLexerMeta(LexerMeta):
    ...
    def _process_new_state(self, new_state, unprocessed, processed):
        ...
        if isinstance(new_state, str):
            ...
            for istate in new_state:
                assert istate in unprocessed or istate in ('#pop', '#push'), f'unknown new state {istate}'
    ...
    def _process_state(self, unprocessed, processed, state):
        ...
        for tdef in unprocessed[state]:
            ...
            try:
                ...
                raise ValueError(("uncompilable regex %r in state %r of %r: %s" % (tdef[0], state, self, err))) from err
