...
class Tag:
    ...
    def __eq__(self, other: object) -> bool:
        return ((self._hash == other._hash) and (self._platform == other._platform) and (self._abi == other._abi) and (self._interpreter == other._interpreter)) if isinstance(other, Tag) else NotImplemented  # Short-circuit ASAP for perf reasons.
