...
class InstallCommand(RequirementCommand):
    ...
    def run(self, options: Values, args: List[str]) -> int:
        ...
        try:
            ...
            if pep517_build_failure_names := [r.name for r in build_failures if r.use_pep517]:  # type:
                raise InstallationError(f'Could not build wheels for {", ".join(pep517_build_failure_names)}, which is required to install pyproject.toml-based projects')
