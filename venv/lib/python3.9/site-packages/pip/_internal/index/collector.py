...
def _match_vcs_scheme(url: str) -> Optional[str]:
    ...
    """
    return next((scheme for scheme in vcs.schemes if url.lower().startswith(scheme) and url[len(scheme)] in "+:"), None)
...
def _create_link_from_element(
    ...
    return Link(url, comes_from=page_url, requires_python=pyrequire, yanked_reason=yanked_reason,)
