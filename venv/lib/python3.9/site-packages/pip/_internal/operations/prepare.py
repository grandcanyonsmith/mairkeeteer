...
class RequirementPreparer:
    ...
    def _ensure_link_req_src_dir(
        ...
        if is_installable_dir(req.source_dir):
            raise PreviousBuildDirError(f"pip can't proceed with requirements '{req}' due to apre-existing build directory ({req.source_dir}). This is likely due to a previous installation that failed . pip is being responsible and not assuming it can delete this. Please delete it and try again.")
    ...
    def _prepare_linked_requirement(
        ...
        if link.is_existing_dir() and self.in_tree_build:
            ...
            try:
                ...
                raise InstallationError(f"Could not install requirement {req} because of HTTP error {exc} for URL {link}") from exc
        ...
        return _get_prepared_distribution(req, self.req_tracker, self.finder, self.build_isolation,)
