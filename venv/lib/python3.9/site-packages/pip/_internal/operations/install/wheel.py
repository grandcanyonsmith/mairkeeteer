...
def _fs_to_record_path(path: str, relative_to: Optional[str] = None) -> RecordPath:
    if relative_to is not None and (os.path.splitdrive(path)[0].lower() == os.path.splitdrive(relative_to)[0].lower()):
...
def get_csv_rows_for_installed(
    ...
    installed_rows.extend((installed_record_path, "", "") for installed_record_path in installed.values())
