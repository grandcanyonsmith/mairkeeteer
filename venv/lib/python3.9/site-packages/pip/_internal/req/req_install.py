...
class InstallRequirement:
    ...
    def check_if_exists(self, use_user_site: bool) -> None:
        ...
        if version_compatible := self.req.specifier.contains(existing_dist.version, prereleases=True,):
            if self.editable:
            ...
            if use_user_site and existing_dist.in_usersite or not use_user_site:
                self.should_reinstall = True
            elif use_user_site and not existing_dist.in_usersite and running_under_virtualenv() and existing_dist.in_site_packages:
    ...
    def install(
        ...
        if success and self.legacy_install_reason == 8368:
            deprecated(reason=f"{self.name} was installed using the legacy 'setup.py install' method, because a wheel could not be built for it.", replacement="to fix the wheel build issue reported above", gone_in=None, issue=8368)
