...
def handle_requirement_line(
    ...
    req_options = {dest: line.opts.__dict__[dest] for dest in SUPPORTED_OPTIONS_REQ_DEST if dest in line.opts.__dict__ and line.opts.__dict__[dest]}
    ...
    def _parse_file(self, filename: str, constraint: bool) -> Iterator[ParsedLine]:
        ...
        for line_number, line in lines_enum:
            try:
                ...
                raise RequirementsFileParseError(msg) from e
...
def get_file_content(url: str, session: PipSession) -> Tuple[str, str]:
    ...
    try:
        ...
        raise InstallationError(f"Could not open requirements file: {exc}") from exc
    return url, content
