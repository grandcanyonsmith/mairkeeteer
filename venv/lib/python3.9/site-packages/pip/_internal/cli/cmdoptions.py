...
def make_target_python(options: Values) -> TargetPython:
    return TargetPython(platforms=options.platforms, py_version_info=options.python_version, abis=options.abis, implementation=options.implementation,)
...
def _handle_merge_hash(
    ...
    if algo not in STRONG_HASHES:
        parser.error(f'Allowed hash algorithms for {opt_str} are {", ".join(STRONG_HASHES)}.')
