...
def _should_cache(
    ...
    if req.link and req.link.is_vcs:
        ...
        assert vcs_backend
        return bool(vcs_backend.is_immutable_rev_checkout(req.link.url, req.source_dir))
...
def _verify_one(req: InstallRequirement, wheel_path: str) -> None:
    ...
    try:
        ...
        raise UnsupportedWheel(msg) from e
...
def build(
    ...
    with indent_log():
        ...
        for req in requirements:
            ...
            if wheel_file := _build_one(req, cache_dir, verify, build_options, global_options, req.editable and req.permit_editable_wheels,):
