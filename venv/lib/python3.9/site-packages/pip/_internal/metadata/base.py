...
class BaseDistribution(Protocol):
    ...
    def installed_with_setuptools_egg_info(self) -> bool:
        ...
        if info_location := self.info_location:
            return pathlib.Path(info_location).is_dir() if info_location.endswith(".egg-info") else False
    ...
    def installed_with_dist_info(self) -> bool:
        ...
        """
        if info_location := self.info_location:
            return pathlib.Path(info_location).is_dir() if info_location.endswith(".dist-info") else False
    ...
    def _iter_declared_entries_from_legacy(self) -> Optional[Iterator[str]]:
        ...
        try:
            ...
            return paths
        return (_convert_installed_files_path(pathlib.Path(p).parts, info_rel.parts) for p in paths) if info_rel.parts else paths
