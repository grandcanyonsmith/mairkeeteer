...
class WheelMetadata:
    ...
    def get_metadata(self, name: str) -> str:
        try:
            ...
            raise UnsupportedWheel(f"Error decoding metadata for {self._wheel_name}: {e} in {name} file") from e
...
class Environment(BaseEnvironment):
    ...
    def _search_distribution(self, name: str) -> Optional[BaseDistribution]:
        ...
        return next((dist for dist in self.iter_distributions() if dist.canonical_name == canonical_name), None)
