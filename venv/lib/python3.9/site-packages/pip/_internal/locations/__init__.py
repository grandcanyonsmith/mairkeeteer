...
def get_scheme(
    ...
    for k in SCHEME_KEYS:
        ...
        skip_linux_system_special_case = not user and not home and not prefix and not running_under_virtualenv() and old_v.parts[1:3] == ("usr", "local") and len(new_v.parts) > 1 and new_v.parts[1] == "usr" and ((len(new_v.parts) < 3 or new_v.parts[2] != "local")) and ((_looks_like_red_hat_scheme() or _looks_like_debian_scheme()))
...
def _looks_like_deb_system_dist_packages(value: str) -> bool:
    ...
    """
    return value == "/usr/lib/python3/dist-packages" if _looks_like_debian_scheme() else False
