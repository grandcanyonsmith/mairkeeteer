...
class BracketTracker:
    ...
    def mark(self, leaf: Leaf) -> None:
        ...
        if self.depth == 0:
            ...
            elif delim := is_split_after_delimiter(leaf, self.previous):
...
def is_split_before_delimiter(leaf: Leaf, previous: Optional[Leaf] = None) -> Priority:
    ...
    if ((leaf.value == "for" and leaf.parent and leaf.parent.type in {syms.comp_for, syms.old_comp_for} or leaf.type == token.ASYNC)) and ((not isinstance(leaf.prev_sibling, Leaf) or leaf.prev_sibling.value != "async")):
