...
class Bar(object):
    ...
    def colour(self, value):
        ...
        try:
            ...
            warn(f'Unknown colour ({value}); valid choices: [hex (#00ff00), {", ".join(self.COLOURS)}]', TqdmWarning, stacklevel=2)
...
class tqdm(Comparable):
    ...
    def format_meter(n, total, elapsed, ncols=None, prefix='', ascii=False, unit='it',
        ...
        if total:
            ...
            return '{0}{1}{2} [{3}, {4}{5}]'.format(f"{prefix}: " if prefix else '', n_fmt, unit, elapsed_str, rate_fmt, postfix)
    ...
    def _decr_instances(cls, instance):
        ...
        with cls._lock:
            ...
            if not instance.gui:
                ...
                if instances := list(filter(lambda i: hasattr(i, "pos") and last <= i.pos, cls._instances)):
    ...
    def __init__(self, iterable=None, desc=None, total=None, leave=True, file=None,
        ...
        if kwargs:
            ...
            with self._lock:
                self.pos = self._get_free_pos(self)
                self._instances.remove(self)
            raise TqdmDeprecationWarning("`nested` is deprecated and automated.\n" "Use `position` instead for manual control.\n", fp_write=getattr(file, 'write', sys.stderr.write)) if "nested" in kwargs else TqdmKeyError(f"Unknown argument(s): {kwargs}")
    ...
    def __reversed__(self):
        try:
            ...
            raise TypeError("'tqdm' object is not reversible") from e
        else:
    ...
    def set_postfix(self, ordered_dict=None, refresh=True, **kwargs):
        ...
        self.postfix = ', '.join(f'{key}={postfix[key].strip()}' for key in postfix.keys())
