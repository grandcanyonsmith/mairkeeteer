...
class Engine(ListableAPIResource, UpdateableAPIResource):
    ...
    def generate(self, timeout=None, **params):
        ...
        while True:
            try:
                return self.request("post", f"{self.instance_url()}/generate", params, stream=params.get("stream"), plain_old_data=True)
    ...
    async def agenerate(self, timeout=None, **params):
        ...
        while True:
            try:
                return await self.arequest("post", f"{self.instance_url()}/generate", params, stream=params.get("stream"), plain_old_data=True)
