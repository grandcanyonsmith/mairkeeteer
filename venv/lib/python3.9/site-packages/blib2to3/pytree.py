...
class Leaf(Base):
    ...
    def __init__(self, type: int, value: Text, context: Optional[Context] = None, prefix: Optional[Text] = None, fixers_applied: List[Any] = None, opening_bracket: Optional["Leaf"] = None) -> None:
        """
        Initializer.
...
class LeafPattern(BasePattern):
    ...
    def match(self, node: NL, results=None) -> bool:
        ...
        return BasePattern.match(self, node, results) if isinstance(node, Leaf) else False
...
class NodePattern(BasePattern):
    ...
    def _submatch(self, node, results=None) -> bool:
        ...
        if len(self.content) != len(node.children):
            return False
        return all(subpattern.match(child, results) for subpattern, child in zip(self.content, node.children))
