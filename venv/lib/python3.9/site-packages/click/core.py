...
class Option(Parameter):
    ...
    def get_help_record(self, ctx: Context) -> t.Optional[t.Tuple[str, str]]:
        ...
        if self.show_envvar:
            ...
            if envvar is None and (self.allow_from_autoenv and ctx.auto_envvar_prefix is not None and self.name is not None):
    ...
    def get_default(
        ...
        if self.is_flag and not self.is_bool_flag:
            return next((param.flag_value for param in ctx.command.params if param.name == self.name and param.default), None)
