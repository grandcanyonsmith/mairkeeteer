    ...
    class _TypedDictMeta(type):
        ...
        def __new__(cls, name, bases, ns, total=True):
            ...
            for annotation_key, annotation_type in own_annotations.items():
                ...
                if annotation_origin is Required or annotation_origin is not NotRequired and total:
...
# 3.7-3.9
    ...
    class ParamSpecArgs(_Immutable):
        ...
        def __eq__(self, other):
            return self.__origin__ == other.__origin__ if isinstance(other, ParamSpecArgs) else NotImplemented
    ...
    class ParamSpecKwargs(_Immutable):
        ...
        def __eq__(self, other):
            return self.__origin__ == other.__origin__ if isinstance(other, ParamSpecKwargs) else NotImplemented
